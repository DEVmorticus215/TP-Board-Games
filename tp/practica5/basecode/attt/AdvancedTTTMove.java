...
public class AdvancedTTTMove extends ConnectNMove {
	 ...
	 * where row and col are integers representing a position, or "row SPACE col
	 * > row SPACE col" to indicate a piece changing position.
	 *
	 * <p>
	 * Se puede construir un movimiento desde un string de la forma "row SPACE
	 * col" donde row y col son enteros que representan una casilla. o "row
	 * SPACE col > row SPACE col" para indicar un movimiento de ficha existente.
	 */
	@Override
